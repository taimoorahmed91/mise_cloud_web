...
<head>
    ...
    <title>MISE &middot; Edit Downloadable ACL</title>
...
<body class="cui">
    ...
    <div class="content content--alt">
        <div class="container-fluid">
            ...
            <?php
$folder = 'dacl'; // Set the folder name to 'allowed protocols'

function getFileLocation($folder, $fileName) {
    $baseDir = '/var/www/html/mise/v0.1/configs/';
    return $baseDir . 'dacl/' . $fileName;
}
...
<form role="form" method="post" action="">
    <div class="panel panel--loose panel--raised base-margin-bottom" style="padding-left: 265px;">
        <h2 class="subtitle">Edit DACL File</h2>
        <hr>
        <div class="section">
                            ...
                            if (empty($file_contents) || empty($file_path) || empty($new_file_name)) {
                                ...
                                if (file_exists($new_file_path)) {
                                    ...
                                    if (file_put_contents($new_file_path, $file_contents) !== false) {
                                        ...
                                        $sql = "INSERT INTO dacl (dacl,daclid,isename) VALUES ('$new_file_name','$new_file_name','MISE')";
