    ...
    <div class="content content--alt">
            ...
            <div class="section">
                <form role="form" method="post" action="deployment_phase2.php">
                    <div class="panel panel--loose panel--raised base-margin-bottom" style="padding-left: 265px;">
                        <h2 class=" subtitle">Policy Set Selection</h2>
                        <hr>
                        <div class="section">
                            <div class="form-group base-margin-bottom">
                                <div class="form-group__text">
                                    <input name="comments" type="text" placeholder="Sample Comment for deployment">
                                    <label for="input-type-text">Deployment Comments</label>
                                </div>
                            </div>
                            <div class="form-group base-margin-bottom">
        ...
        <select name="selectedpolicyset">
            ...
            ?>
                    ...
                    <input type="submit" class="btn btn--success" value="Finalize Replication" />
