...
<head>
    ...
    <title>MISE &middot; Element Comparison</title>
...
<form role="form" method="post" action="">
    <div class="panel panel--loose panel--raised base-margin-bottom" style="padding-left: 265px;">
        <h2 class="subtitle">Comparison Result</h2>
        <hr>
        <div class="section">
        <textarea name="file_contents" rows="30" cols="100%" readonly><?php echo htmlspecialchars($output); ?></textarea>
