...
<head>
    ...
    <title>MISE &middot; Credential Manager</title>
...
<body class="cui">
    ...
    <div class="content content--alt">
        <div class="container-fluid">
            ...
            <div class="section">
                <form role="form" method="post" action="credentials.php">
                    <div class="panel panel--loose panel--raised base-margin-bottom" style="padding-left: 265px;">
                        <h2 class=" subtitle">ISE Cube credentials</h2>
                        <hr>
                        <div class="section">
                            ...
                            <div class="form-group base-margin-bottom">
                                <div class="form-group__text">
                                    <input name="password" type="password" value="11111111">
                                    <label for="input-type-text">Password</label>
                                </div>
                                </div>
                                <div class="form-group base-margin-bottom">
                                <div class="form-group__text">
                                    <input name="radkitid" type="password" value="1111111">
                                    <label for="input-type-text">RadkitID</label>
                                </div>
                                </div>
                                <input type="submit" class="btn btn--success" value="Update credentials"
