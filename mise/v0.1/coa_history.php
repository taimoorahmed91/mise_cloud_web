...
$offset = ($pageNumber - 1) * $rowsPerPage;
  ...
  //Create the select query
  $query ="SELECT * FROM coahistory ORDER BY id DESC LIMIT $rowsPerPage OFFSET $offset";
  //Get results
  $result = $mysqli->query($query) or die($mysqli->error.__LINE__);
?>
...
<?php
    ...
    $totalCountQuery = "SELECT COUNT(*) as total FROM coahistory";
...
<head>
    ...
    <title>MISE &middot; CoA History</title>
                    ...
                    <h2>CoA History </h2>
                        <thead>
                            <tr>
                                    ...
                                    <th class="hidden-md-down">ISE Name</th>
                                    <th class="hidden-md-down">Response Code</th>
