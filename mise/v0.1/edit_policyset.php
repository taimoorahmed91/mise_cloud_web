...
<head>
    ...
    <title>MISE &middot; Edit Policyset</title>
...
<body class="cui">
    ...
    <div class="content content--alt">
        <div class="container-fluid">
            ...
            <?php
$folder = 'policyset'; // Set the folder name to 'allowed protocols'

function getFileLocation($folder, $fileName) {
    $baseDir = '/var/www/html/mise/v0.1/configs/';
    return $baseDir . 'policyset/' . $fileName;
}
...
<form role="form" method="post" action="">
    <div class="panel panel--loose panel--raised base-margin-bottom" style="padding-left: 265px;">
        <h2 class="subtitle">Edit Policyset File</h2>
        <hr>
        <div class="section">
