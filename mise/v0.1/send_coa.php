...
<?php
    if (isset($_GET['button'])) {
        ...
        if ($button == 1) {
            ...
            header("Location: coa.php?mac=$mac&ise=$ise");
            exit();
        } elseif ($button == 2) {
            // Button 2 was clicked, redirect to page2.php
            header("Location: coaall.php?mac=$mac");
            exit();
        }
    }
    ?>
...
<head>
    ...
    <title>MISE &middot; Send CoA</title>
...
<body class="cui">
    ...
    <div class="content content--alt">
        <div class="container-fluid">
            ...
            <div class="section">
        <form role="form" method="GET" action="send_coa.php">
            <div class="panel panel--loose panel--raised base-margin-bottom" style="padding-left: 265px;">
                <h2 class="subtitle">Send CoA</h2>
                <hr>
                <div class="section">
                    <div class="form-group base-margin-bottom">
                        <div class="form-group__text">
                            <input name="mac" type="text" placeholder="MAC Address">
                        </div>
                    </div>
                    <div class="form-group base-margin-bottom">
                        <div class="form-group__text">
                            <input name="ise" type="text" placeholder="ISE Node">
                        </div>
                    </div>
                    <div class="form-group base-margin-bottom">
                    <button type="submit" class="btn btn--success" name="button" value="1" style="margin-top: 10px; color:white">CoA to Single Deployment</button>
                    </div>
                    <div class="form-group base-margin-bottom">
                    <button type="submit" class="btn btn--success" name="button" value="2" style="margin-top: 10px; color:white">CoA to All Deployments   </button>
                    </div>
                    </div>
                </div>
            </div>
