...
$offset = ($pageNumber - 1) * $rowsPerPage;
  ...
  $query ="SELECT * FROM nodes ORDER BY id LIMIT $rowsPerPage OFFSET $offset";
  //Get results
...
<?php
    ...
    $totalCountQuery = "SELECT COUNT(*) as total FROM nodes";
...
<head>
    ...
    <title>MISE &middot; ISE Personas</title>
            ...
            <div class="section">
                <div  class="panel panel--loose panel--raised base-margin-bottom" style="padding-left: 235px;"> 
                    <table class="table table--lined table--selectable">
                        <h2> ISE Cube Personas</h2>
                        <thead>
                            <tr>
 
                                <th class="hidden-lg-down">ID</th>
                                <th class="hidden-lg-down">ISE Cube</th>
                                <th class="hidden-lg-down">Node FQDN</th>
                                <th class="hidden-lg-down">IP Address</th>
                                <th class="hidden-lg-down">Roles</th>
                                <th class="hidden-lg-down">Services</th>
                                <th class="hidden-lg-down">Status</th>
                                <th></th>
                            </tr>
                        </thead>
                        <tbody>
                            ...
                            while($row = $result->fetch_assoc()){
                              ...
                              $output .='<td>'.$row['roles'].'</td>';
                              $output .='<td>'.$row['services'].'</td>';
                              $output .='<td>'.$row['nodestatus'].'</td>';
                              $output .='</tr>';
