...
$name = $_GET['name'];
  ...
  //Create the select query
  $query ="SELECT * FROM authentication WHERE authentication LIKE '%$name%' ORDER BY id ";
  //Get results
  $result = $mysqli->query($query) or die($mysqli->error.__LINE__);
?>
...
<body class="cui">
  ...
  <div class="form-group form-group--inline input--icon">
    <div class="form-group__text">
      <form action="authentication-search-result.php" method="GET"> <!-- Assuming the separate page is named "search-results.php" -->
        <input type="search" name="name" placeholder="Search Authentication Rules" style="width:320px">
