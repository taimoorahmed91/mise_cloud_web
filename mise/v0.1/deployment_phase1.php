        ...
        <div class="container-fluid">
            ...
            <div class="section">
                <div  class="panel panel--loose panel--raised base-margin-bottom" style="padding-left: 235px;"> 
                    <table class="table table--lined table--selectable">
                        ...
                        <thead>
                            <tr>
                                ...
                                <th class="hidden-lg-down">Marked for Deployment</th>
                    ...
                    <form method="post" action="deploy.php" onsubmit="showLoadingSpinner()">
                    <input type="submit" name="export" value="Deploy" class="btn btn--success" style="color:white"/>
                    </form>
                    ...
                    <div class="col-md-2">
                    <div id="loadingSpinner" class="loading-dots loading-dots--success" aria-label="Loading, please wait..." style="display: none;">
                    <span></span>
                    <span></span>
                    <span></span>
                    </div>
