...
<head>
    ...
    <title>MISE &middot; Edit Authorization Rules</title>
...
<body class="cui">
    ...
    <div class="content content--alt">
        <div class="container-fluid">
            ...
            <?php
$folder = 'authorizations'; // Set the folder name to 'allowed protocols'

function getFileLocation($folder, $fileName) {
    $baseDir = '/var/www/html/mise/v0.1/configs/';
    return $baseDir . 'authorizations/' . $fileName;
}
                            ...
                            if (empty($file_contents) || empty($file_path) || empty($new_file_name)) {
                                ...
                                if (file_exists($new_file_path)) {
                                    ...
                                    if (file_put_contents($new_file_path, $file_contents) !== false) {
                                        ...
                                        $sql = "INSERT INTO authorization (authorization,authorizationid,isename) VALUES ('$new_file_name','$new_file_name','MISE')";
