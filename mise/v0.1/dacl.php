...
$offset = ($pageNumber - 1) * $rowsPerPage;
  ...
  //Create the select query
  $query ="SELECT * FROM dacl ORDER BY id LIMIT $rowsPerPage OFFSET $offset";
  //Get results
  $result = $mysqli->query($query) or die($mysqli->error.__LINE__);
?>
...
<?php
    ...
    $totalCountQuery = "SELECT COUNT(*) as total FROM dacl";
...
<head>
    ...
    <title>MISE &middot; Downloadable ACLs</title>
...
<body class="cui">
  ...
  <div class="form-group form-group--inline input--icon">
    <div class="form-group__text">
      <form action="dacl-search-result.php" method="GET"> <!-- Assuming the separate page is named "search-results.php" -->
        <input type="search" name="name" placeholder="Search downloadable ACLs" style="width:320px">
        ...
        <div class="container-fluid">
            ...
            <div class="section">
                <div  class="panel panel--loose panel--raised base-margin-bottom" style="padding-left: 235px;"> 
                    ...
                    <h2> Downloadable ACLs </h2>
                        <thead>
                            <tr>
                                    <th class="hidden-md-down">ID </span></th>
                                    <th class="hidden-md-down">DACL Name</th>
