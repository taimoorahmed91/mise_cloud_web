...
if(isset($_GET['id'])) {
    ...
    $command = "sudo -S docker exec misepy python3 /root/ise-landscape/mise/authorization_add_queue.py $id";

    // Execute command using shell_exec
    shell_exec($command);

    // Redirect back to authorization.php after adding to the queue
