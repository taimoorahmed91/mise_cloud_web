        ...
        <div class="container-fluid">
            ...
            <div class="section">
                <div  class="panel panel--loose panel--raised base-margin-bottom" style="padding-left: 235px;"> 
                    <table class="table table--lined table--selectable">
                        ...
                        <tbody>
                            ...
                            while($row = $result->fetch_assoc()){
                              ...
                              $output .='<td><a href="mark_deployment.php?id='.$row['id'].'" class="btn btn--success" style="color:white"">Mark/Un-Mark</a></td>';
                              $output .='</tr>';
                    ...
                    <div  class="panel panel--loose panel--raised base-margin-bottom" style="padding-left: 235px;"> 
                    <a href="deployment_phase2.php" class="btn btn--success" style="color:white">Next</a>
